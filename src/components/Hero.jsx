    ...
    return (
        <div className='flex gap-[40px] items-center pl-[15em] pt-[100px]'>
            <div className='relative'>
                <img src={arrow} alt="arrow" className='absolute inset-y-0 -top-[80px] left-[100px] animate-bounce' />
                ...
                <div className='relative'>
                    ...
                    <img src={myimage} alt="my-image" className='h-[250px] relative z-[10px] animate-bounce' />
                </div>
            </div>
